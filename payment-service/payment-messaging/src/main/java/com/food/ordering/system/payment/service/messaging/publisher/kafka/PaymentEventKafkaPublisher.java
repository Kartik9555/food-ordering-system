...
public class PaymentEventKafkaPublisher implements PaymentResponseMessagePublisher {
    ...
    public void publish(
        ...
        OrderEventPayload orderEventPayload = kafkaMessageHelper.getOrderEventPayload(outboxMessage.getPayload(), OrderEventPayload.class);
        ...
        try {
            ...
            log.error("Error while sending PaymentResponseAvroModel message to kafka with order id: {} and saga id: {}", orderEventPayload.getOrderId(), sagaId);
        }
    }
}
