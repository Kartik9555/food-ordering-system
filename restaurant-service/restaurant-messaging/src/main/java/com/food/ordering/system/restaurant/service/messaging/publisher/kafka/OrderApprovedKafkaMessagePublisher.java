...
public class OrderApprovedKafkaMessagePublisher implements OrderApprovedMessagePublisher {
    ...
    public void publish(OrderApprovedEvent domainEvent) {
        ...
        log.info("Received Order approval event for order id: {}", orderId);
        try {
            RestaurantApprovalResponseAvroModel restaurantApprovalResponseAvroModel = restaurantMessagingDataMapper.orderApprovalEventToRestaurantApprovalResponseAvroModel(domainEvent);
            kafkaProducer.send(
